...
class VaultSecret(Base64Ref):
    ...
    def _encrypt(self, data, encode_base64):
        ...
        try:
            ...
            request = client.secrets.transit.encrypt_data(
                name=self.vault_params.get("key"),
            ...
            self.key = self.vault_params.get("key")
    ...
    def _decrypt(self, data):
        ...
        client = vault_obj(self.vault_params)
        try:
            request = client.secrets.transit.decrypt_data(
                name=self.vault_params.get("key"),
