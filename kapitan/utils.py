...
def render_jinja2_file(name, context, jinja2_filters=os.path.join('lib', 'jinja2_filters.py')):
...
def render_jinja2(path, context, jinja2_filters=os.path.join('lib', 'jinja2_filters.py')):
    """
