...
export TF_DATA_DIR=$(realpath -m ${DIR}/../../../.TF_DATA_DIR/project3) # Folder for TF initialization (preferable outside of compiled)
export OUTPUT_DIR=$(realpath -m ${DIR}/../../../output/project3) # Folder for storing output files (preferable outside of compiled)
