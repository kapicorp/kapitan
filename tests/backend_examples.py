...
"""Shared configuration for backend example compile tests and golden snapshot refresh.

Both the test suite and ``scripts/refresh_backend_goldens.py`` consume this module
...
GOLDEN_BASE = os.path.join(TEST_PWD, "tests", "golden", "backend_examples")
