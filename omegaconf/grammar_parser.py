...
SIMPLE_INTERPOLATION_PATTERN = re.compile(f"({_outer})?({_inter}({_outer})?)+$", flags=re.ASCII)
...
class OmegaConfErrorListener(ErrorListener):  # type: ignore
    ...
    def reportAttemptingFullContext(
        ...
        raise GrammarParseError("ANTLR error: Attempting Full Context")  # pragma: no cover
